...
export default function BlogListingPage() {
  return (
    <main className="min-h-screen bg-[#f8f8f6] pt-28 pb-24 px-6 md:px-12">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16 space-y-6">
          <Link
            href="/#blog"
            className="inline-flex items-center gap-2 text-gray-400 hover:text-orange-500 text-[11px] font-semibold transition-colors uppercase tracking-widest"
          >
        ...
        <Link href={`/blog/${blogPosts[0].slug}`} className="group block mb-16">
          <div className="grid md:grid-cols-[4fr_6fr] items-stretch bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden transition-all hover:shadow-md">
            ...
            <div className="p-8 md:p-12 flex flex-col justify-center space-y-5">
              ...
              <h2 className="text-2xl font-bold text-[#0f1f2e] group-hover:text-orange-600 transition-colors leading-snug">
                {blogPosts[0].title}
              </h2>
              ...
              <div className="pt-2">
                <span className="inline-flex items-center gap-1.5 text-gray-500 hover:text-orange-500 font-semibold text-xs uppercase tracking-widest transition-all">
            ...
            <Link key={post.slug} href={`/blog/${post.slug}`} className="group h-full">
              <article className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden transition-all hover:shadow-md flex flex-col h-full">
                ...
                <div className="p-5 flex flex-col flex-grow space-y-3">
                  ...
                  <h3 className="text-base font-bold text-[#0f1f2e] group-hover:text-orange-600 transition-colors leading-snug">
                    {post.title}
                  </h3>
                  ...
                  <div className="pt-4 mt-auto">
                    <span className="inline-flex items-center gap-1.5 text-gray-400 hover:text-orange-500 font-semibold text-xs uppercase tracking-wide transition-all">
                      Read Article <ArrowUpRight size={14} />
                    </span>
                  </div>
                </div>
