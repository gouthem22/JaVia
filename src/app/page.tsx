  ...
  return (
    <main className="flex min-h-screen flex-col items-center">
      ...
      <section id="home" className="relative w-full min-h-screen flex items-center md:items-end px-6 md:px-12 pt-[var(--navbar-height)] pb-12 md:pb-24 overflow-hidden bg-black">
        ...
        <div className="relative w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12" style={{ zIndex: 2 }}>
          <div className="space-y-8 max-w-7xl text-center md:text-left">
            <h1
              className="font-normal uppercase tracking-tighter"
              style={{ 
                fontFamily: "var(--font-bebas)", 
                color: "#9ca3af",
                fontSize: "clamp(2.5rem, calc(2rem + 8vw), 7.5rem)",
                lineHeight: "0.85",
            ...
            <p className="text-base md:text-xl text-white/70 max-w-2xl mx-auto md:mx-0 leading-relaxed font-medium">
      ...
      <section id="fruithouse" className="w-full py-32 md:py-48 px-4 bg-white">
