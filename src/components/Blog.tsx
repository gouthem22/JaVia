            ...
            <div className="max-w-6xl mx-auto space-y-16">
                <div className="flex flex-col md:flex-row justify-between items-end gap-8">
                    <div className="space-y-4 max-w-2xl">
                        <span className="text-slate-400 font-bold tracking-widest uppercase text-sm">Insights</span>
                    ...
                    <Link
                        href="/blog"
                        className="px-8 py-4 bg-slate-900 text-white font-bold rounded-full hover:bg-black transition-all hover:-translate-y-1 shadow-sm hover:shadow-lg"
                    >
                        View All Articles
                    </Link>
                </div>
                            ...
                            <Link href={`/blog/${post.slug}`}>
                                <div className="relative aspect-[16/10] overflow-hidden rounded-3xl mb-6 bg-stone-100">
                                    ...
                                    <div className="absolute top-4 left-4">
                                        <span className="px-3 py-1.5 bg-slate-900/90 backdrop-blur-sm text-white text-[10px] font-bold uppercase tracking-[0.1em] rounded-full shadow-sm">
                                            {post.category}
                                        </span>
                                    </div>
                                </div>
